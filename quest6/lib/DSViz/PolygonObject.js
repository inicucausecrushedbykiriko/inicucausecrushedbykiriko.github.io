...
import SceneObject from "/quest6/lib/DSViz/SceneObject.js"
import Polygon from "/quest6/lib/DS/Polygon.js"
...
export default class PolygonObject extends SceneObject {
  ...
  async createShaders() {
    let shaderCode = await this.loadShader("/quest6/shaders/standard2d.wgsl");
