...
async function init() {
  ...
  camera._mode = "orthographic"; // initial camera mode
  ...
  // Register camera key events using the new method.
  camera.setupKeyEvents(() => {
    tracerObj.updateCameraPose();
    tracerObj.updateCameraFocal();
    updateHelpText();
  });

  // Additional key events for object manipulation:
