...
export default class DemoTreeObject extends Standard2DPGAPosedVertexColorObject {
  constructor(device, canvasFormat, pose) {
    let _vertices = new Float32Array([
       ...
       0,  0.05, 255/255, 255/255 , 255/255, 1, // A triangle for a layer of the Xmas tree
       -0.1, -0.15, 255/255, 255/255 , 255/255, 1,
       0.1, -0.15, 255/255, 255/255 , 255/255, 1,
       
       0,  0.10, 200/255, 200/255 , 200/255, 1, // A triangle for a layer of the Xmas tree
       -0.2, -0.10, 200/255, 200/255 , 200/255, 1,
       0.2, -0.10, 200/255, 200/255 , 200/255, 1,
       
       0,  0.15, 180/255, 180/255 , 180/255, 1, // A triangle for a layer of the Xmas tree
       -0.1, -0.05, 180/255, 180/255 , 180/255, 1,
       0.1, -0.05, 180/255, 180/255 , 180/255, 1,
       
       0,  0.2, 130/255, 130/255 , 130/255, 1, // A triangle for a layer of the Xmas tree
       -0.1,  0.0, 130/255, 130/255 , 130/255, 1,
       0.1,  0.0, 130/255, 130/255 , 130/255, 1,
    ]); 
